...
print("importing  tools 34-005")
#import helloworldbasic5message as rd


# modification
# modification 2 of 2 - import local lib instead of hwb5message
...
def get_filtered(df_use,minhr1,minhr2,minHPC,minCh,mincount):
    df_copy=df_use.copy()
...
def get_items(df, minHR1,minhr2,minHPC,minCh):
    ...
    extension=""  ## added this 3 dec , (modification 1 of 2)
...
def program34(minhr1,minhr2,minHPC,minCh,mincount,raindoc,listlimit,createfiles):
    ...
    df_out1=get_filtered( df_main,minhr1,minhr2,minHPC,minCh,mincount )
